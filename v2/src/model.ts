...
export interface TabState { id: string; parentId?: string; runtimeId?: number; windowId?: number; title: string; url: string; favicon?: string; index: number; groupId?: string; pinned: boolean; sleeping: boolean; active: boolean }
...
export interface LogicalTab { id: string; runtimeId: number; parentId?: string; title: string; url: string; createdAt: number; closedAt?: number }
